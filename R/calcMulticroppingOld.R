#' @title calcMulticroppingOld
#' @description calculates a multiple cropping factor based on area harvested,
#'              physical cropland area (and optionally fallow land). This function
#'              is an outdated version of calcMulticropping that is kept for
#'              Legacy reasons only for calcCropareaFAOLUH
#'
...
calcMulticroppingOld <- function(extend_future = FALSE, factortype = "CI") {   # nolint
  ...
  # harvested area
  harv   <- collapseNames(dimSums(calcOutput("CropareaFAOLUH", physical = FALSE,
